...
const CATALOG_PRODUCTS = [
  ...
  { id:'AI001SF', code:'AI001SF', cat:'desechables', name:'Micro Aplicador Super Fino',
    unit:'caja 100 pz', img:'imagenes/desechables/pag_01.jpg',
  ...
  { id:'AI003', code:'AI003', cat:'desechables', name:'Cucharilla de Impresión Verde',
    unit:'paquete 10 pz', img:'imagenes/desechables/pag_01.jpg',
  ...
  { id:'AI004', code:'AI004', cat:'desechables', name:'Barrera Protectora Azul',
    unit:'1 200 hojas', img:'imagenes/desechables/pag_01.jpg',
  ...
  { id:'AI007', code:'AI007', cat:'desechables', name:'Dispensador de Barrera Protectora',
    unit:'pieza', img:'imagenes/desechables/pag_01.jpg',
  ...
  { id:'AI008', code:'AI008', cat:'desechables', name:'Cepillo Profiláctico',
    unit:'paquete 100 pz', img:'imagenes/desechables/pag_01.jpg',
  ...
  { id:'AI011', code:'AI011', cat:'desechables', name:'Pistola Dosificadora de Cartuchos 1:1',
    unit:'pieza', img:'imagenes/desechables/pag_01.jpg',
  ...
  { id:'AI012', code:'AI012', cat:'desechables', name:'Pistola Dosificadora de Cartuchos 10:1',
    unit:'pieza', img:'imagenes/desechables/pag_01.jpg',
  ...
  { id:'AI013', code:'AI013', cat:'desechables', name:'Puntas Mezcladoras Amarillas 70×14mm',
    unit:'50 pz', img:'imagenes/desechables/pag_02.jpg',
  ...
  { id:'AI014', code:'AI014', cat:'desechables', name:'Punta Intra Oral Amarilla Ø0.5mm',
    unit:'100 pz', img:'imagenes/desechables/pag_02.jpg',
  ...
  { id:'AI021', code:'AI021', cat:'desechables', name:'Clip de Babero Dental 39.7cm',
    unit:'pieza', img:'imagenes/desechables/pag_02.jpg',
  ...
  { id:'AI022', code:'AI022', cat:'desechables', name:'Espejo Forma Muela 24.6×13.4cm',
    unit:'pieza', img:'imagenes/desechables/pag_02.jpg',
  ...
  { id:'AI023', code:'AI023', cat:'desechables', name:'Lente Naranja Protección UV',
    unit:'pieza', img:'imagenes/desechables/pag_02.jpg',
  ...
  { id:'AI024', code:'AI024', cat:'desechables', name:'Caja de Babero Dental C/500pz',
    unit:'caja 500 pz', img:'imagenes/desechables/pag_02.jpg',
  ...
  { id:'AI024NE', code:'AI024NE', cat:'desechables', name:'Caja de Babero Dental Negro C/500pz',
    unit:'caja 500 pz', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI025', code:'AI025', cat:'desechables', name:'Caja Aluminio p/Fresas y Limas 72 cav.',
    unit:'pieza', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI026', code:'AI026', cat:'desechables', name:'Caja Aluminio p/Limas 72 cav.',
    unit:'pieza', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI027', code:'AI027', cat:'desechables', name:'Caja Aluminio p/Fresas 30 cav. Base Hueca',
    unit:'pieza', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI028', code:'AI028', cat:'desechables', name:'Caja Aluminio p/Fresas 30 cav. Base Sólida',
    unit:'pieza', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI029', code:'AI029', cat:'desechables', name:'Caja Sombreado Mezclador p/Resina',
    unit:'pieza', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI030', code:'AI030', cat:'desechables', name:'Muelitas Caja Plástica p/Piezas Dentales',
    unit:'caja 10 pz', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI032', code:'AI032', cat:'desechables', name:'Sujetador de Impresiones Radiográficas',
    unit:'pieza', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI033', code:'AI033/034', cat:'desechables', name:'Retractor de Labio GDE/CH TPE Blanco',
    unit:'pieza', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI035', code:'AI035/036/037', cat:'desechables', name:'Bloque de Mordida CH/M/GDE',
    unit:'pieza', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI038', code:'AI038', cat:'desechables', name:'Puntas para Jeringa Triple Colores (bote 250pz)',
    unit:'bote 250 pz', img:'imagenes/desechables/pag_03.jpg',
  ...
  { id:'AI039', code:'AI039', cat:'desechables', name:'Jeringa Triple de Agua y Aire Metálica',
    unit:'pieza', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI040', code:'AI040/040M/040G', cat:'desechables', name:'Cucharillas para Fluoruro en Gel',
    unit:'paquete', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI041AZ', code:'AI041AZ', cat:'desechables', name:'Charola Esterilizar GDE 8 Instrumentos',
    unit:'pieza', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI042AM', code:'AI042AM', cat:'desechables', name:'Charola Esterilizar CH 5 Instrumentos',
    unit:'pieza', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI043', code:'AI043', cat:'desechables', name:'Colimadores Posicionadores RX',
    unit:'set', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI044', code:'AI044', cat:'desechables', name:'Contraángulo Desechable Copa Suave',
    unit:'pieza', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI045', code:'AI045', cat:'desechables', name:'Anillo Codificador Instrumentos Grande',
    unit:'paquete', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI046AM', code:'AI046AM', cat:'desechables', name:'Anillo Codificador Instrumentos Chico',
    unit:'paquete', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI047', code:'AI047', cat:'desechables', name:'Block Papel para Mezclar Dental (10 libretas)',
    unit:'10 libretas', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI048', code:'AI048', cat:'desechables', name:'Cinta Testigo 21mm × 50mts',
    unit:'rollo 50 mts', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'AI049', code:'AI049', cat:'desechables', name:'Cánula de Aspiración Blanca CQ (25pz)',
    unit:'paquete 25 pz', img:'imagenes/desechables/pag_04.jpg',
  ...
  { id:'OPEST', code:'OPEST', cat:'desechables', name:'Eyector de Saliva (bolsa 100pz)',
    unit:'bolsa 100 pz', img:'imagenes/desechables/pag_04.jpg',
  ...
  // ══════════════════════════════════════════
  { id:'fresa-BR-M', code:'BR series · M', cat:'fresas', name:'Fresa Taper Round – Grano Medio',
    unit:'pieza', img:'imagenes/fresas/pag_03.jpg',
  ...
  { id:'fresa-BR-largo', code:'BR-L series · M', cat:'fresas', name:'Fresa Taper Round Largo – Grano Medio',
    unit:'pieza', img:'imagenes/fresas/pag_03.jpg',
  ...
  { id:'fresa-BC', code:'BC series · M', cat:'fresas', name:'Fresa Ball Convexity – Grano Medio',
    unit:'pieza', img:'imagenes/fresas/pag_03.jpg',
  ...
  { id:'fresa-SI', code:'SI series', cat:'fresas', name:'Fresa Straight Ogival – Medio/Fino',
    unit:'pieza', img:'imagenes/fresas/pag_03.jpg',
  ...
  { id:'fresa-SF', code:'SF series · M', cat:'fresas', name:'Fresa Straight Flat – Grano Medio',
    unit:'pieza', img:'imagenes/fresas/pag_03.jpg',
  ...
  { id:'fresa-SR', code:'SR series', cat:'fresas', name:'Fresa Straight Round – Fino',
    unit:'pieza', img:'imagenes/fresas/pag_03.jpg',
  ...
  { id:'fresa-TC', code:'TC series', cat:'fresas', name:'Fresa Taper Cone – Fino / Extra Fino',
    unit:'pieza', img:'imagenes/fresas/pag_03.jpg',
  ...
  { id:'fresa-WR', code:'WR series · M', cat:'fresas', name:'Fresa Wheel Round – Grano Medio',
    unit:'pieza', img:'imagenes/fresas/pag_03.jpg',
  ...
  { id:'fresa-EX', code:'EX/DI series', cat:'fresas', name:'Fresa Special Shape / Double Inverted',
    unit:'pieza', img:'imagenes/fresas/pag_03.jpg',
  ...
  // ══════════════════════════════════════════
  { id:'bkt-mbt018-metal', code:'MBT .018 Eclipse', cat:'ortodoncia', name:'Brackets Metálicos MBT .018 – Eclipse',
    unit:'set 20 brackets', img:'imagenes/ortodoncia/pag_02.jpg',
  ...
  { id:'bkt-mbt022-metal', code:'MBT .022 Eclipse', cat:'ortodoncia', name:'Brackets Metálicos MBT .022 – Eclipse',
    unit:'set 20 brackets', img:'imagenes/ortodoncia/pag_02.jpg',
  ...
  { id:'bkt-roth018-metal', code:'Roth .018 Eclipse', cat:'ortodoncia', name:'Brackets Metálicos Roth .018 – Eclipse',
    unit:'set 20 brackets', img:'imagenes/ortodoncia/pag_02.jpg',
  ...
  { id:'bkt-roth022-metal', code:'Roth .022 Eclipse', cat:'ortodoncia', name:'Brackets Metálicos Roth .022 – Eclipse',
    unit:'set 20 brackets', img:'imagenes/ortodoncia/pag_02.jpg',
  ...
  { id:'bkt-roth022-cer', code:'Roth .022 Cerámico Plus', cat:'ortodoncia', name:'Brackets Cerámicos Roth .022 – Plus',
    unit:'set 20 brackets', img:'imagenes/ortodoncia/pag_02.jpg',
  ...
  { id:'bkt-evo-roth022', code:'Evolution Roth .022', cat:'ortodoncia', name:'BKT Autoligado Evolution – Roth .022',
    unit:'set', img:'imagenes/ortodoncia/pag_04.jpg',
  ...
  { id:'bkt-evo-mbt022', code:'Evolution MBT .022', cat:'ortodoncia', name:'BKT Autoligado Evolution – MBT .022',
    unit:'set', img:'imagenes/ortodoncia/pag_04.jpg',
  ...
  // ══════════════════════════════════════════
  { id:'inst-pinzas-orto', code:'Pinzas Ortodoncia', cat:'instrumental', name:'Pinzas para Ortodoncia – Acero Inoxidable',
    unit:'pieza', img:'imagenes/instrumental/pag_01.jpg',
  ...
  { id:'inst-tijeras', code:'Tijeras Dentales', cat:'instrumental', name:'Tijeras y Portaagujas Dentales',
    unit:'pieza', img:'imagenes/instrumental/pag_03.jpg',
  ...
  { id:'inst-exploradores', code:'Exploradores y Espejos', cat:'instrumental', name:'Exploradores y Espejos Dentales',
    unit:'pieza', img:'imagenes/instrumental/pag_03.jpg',
  ...
  // ══════════════════════════════════════════
  { id:'pd-composite', code:'Prime Dent Composite', cat:'primadent', name:'Resina Compuesta Prime Dent',
    unit:'jeringa', img:'imagenes/primadent/pag_01.jpg',
  ...
  { id:'pd-adhesivo', code:'Prime Dent Bond', cat:'primadent', name:'Adhesivo Universal Prime Dent',
    unit:'frasco', img:'imagenes/primadent/pag_01.jpg',
  ...
  { id:'pd-cemento', code:'Prime Dent Cement', cat:'primadent', name:'Cemento de Ionómero de Vidrio',
    unit:'polvo + líquido', img:'imagenes/primadent/pag_01.jpg',
  ...
  // ══════════════════════════════════════════
  { id:'ae-scalers', code:'American Eagle EXD', cat:'americaneagle', name:'Scalers y Curetas American Eagle',
    unit:'pieza', img:'imagenes/americaneagle/pag_02.jpg',
  ...
  { id:'hf-instruments', code:'Hu-Friedy Premium', cat:'hufriedygroup', name:'Instrumental Hu-Friedy',
    unit:'pieza', img:'imagenes/hufriedygroup/pag_02.jpg',
  ...
  { id:'medesy-forceps', code:'Medesy Forceps', cat:'medesy', name:'Forceps y Elevadores Medesy',
    unit:'pieza', img:'imagenes/medesy/pag_02.jpg',
  ...
  { id:'vamasa-varios', code:'Vamasa Catalogo', cat:'vamasa', name:'Catálogo Vamasa – Material Dental',
  ...
  { id:'borgatta-mat', code:'Borgatta México', cat:'borgatta', name:'Material Borgatta México 2021',
  ...
  { id:'balsas-varios', code:'Balsas Dental', cat:'balsas', name:'Catálogo Balsas Dental',
  ...
  { id:'elasticos-ao', code:'Elásticos A.O.', cat:'elasticos', name:'Elásticos de Ortodoncia A.O.',
  ...
  { id:'lb-kit', code:'Línea Black', cat:'lineablack', name:'Kit Línea Black – Material Estético',
  ...
  { id:'bioart-artic', code:'Articulador Bioart', cat:'articulador', name:'Articulador Semiajustable Bioart',
  ...
  { id:'gnatus-auto', code:'Autoclave Gnatus', cat:'autoclave', name:'Autoclave Gnatus – Esterilización Clase B',
  ...
  { id:'primervg-sensor', code:'Prime RVG', cat:'primervg', name:'Sensor de Radiografía Digital Prime RVG',
