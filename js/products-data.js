...
const CATALOG_PRODUCTS = [
  ...
  {id:'balsas-019', code:'C500100', cat:'instrumental', brand:'balsas', name:'Hi-Tray Metal — Portaimpresion Metalica', unit:'par', img:'imagenes/balsas/pag_32.jpg', desc:'Cubeta de acero inoxidable especial BSA con 16.70% de cromo y bordes retentivos. Esterilizable en seco y en autoclave. Sistema Rim Lock para adhesion del material.', specs:['Alta resistencia a la deformacion','Mayor exactitud de la impresion','Disponible: Solido y Perforado','Superior e Inferior']},
  {id:'balsas-020', code:'C500200', cat:'instrumental', brand:'balsas', name:'Hi-Tray Light Clear — Portaimpresion Plastica', unit:'pieza', img:'imagenes/balsas/pag_32.jpg', desc:'Cubeta estandar de plastico transparente extra rigido. Esterilizable en autoclave. Disponible en varias medidas y formas.', specs:['Small/Medium/Large superior e inferior','Parcial superior derecho e izquierdo','Rigida para evitar distorsiones']},
